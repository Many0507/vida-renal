...
$app->get('/admin/gastos-fijos/{month}/{year}', 'AdminViewsController:gastosFijos');
$app->get('/admin/sueldos/{month}/{year}', 'AdminViewsController:sueldos');
$app->get('/admin/actualizar/{tipo}/{id}/{month}/{year}', 'AdminViewsController:actualizar');
...
$app->post('/admin/gastos-fijos', 'ApiController:crearGastoFijo');
$app->post('/admin/sueldos', 'ApiController:crearSueldo');
$app->post('/admin/actualizar/{tipo}/{id}', 'ApiController:actualizar');
